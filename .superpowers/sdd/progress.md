...
- Task 1: pending — HIR method (HirMethod) + This node
- Task 2: pending — lower this + collect struct methods into HirClass
- Task 3: pending — emit class methods + this, Node round-trip
